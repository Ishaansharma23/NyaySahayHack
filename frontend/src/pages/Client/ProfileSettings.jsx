                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <select
                                        id="state"
                                        className="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg shadow-sm bg-white focus:outline-none focus:ring-2 focus:ring-indigo-500"
                                        value={selectedState}
                            ...
                            <div className="md:col-span-2">
                                ...
                                <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-lg">
                                    <div className="space-y-1 text-center">
                                        ...
                                        {idProof && (
                                            <p className="text-sm text-green-600">{idProof.name} selected</p>
                                        )}
                                    </div>
                                </div>
                            </div>
