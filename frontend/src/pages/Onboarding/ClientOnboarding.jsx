    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-black py-12 px-4 sm:px-6 lg:px-8">
            <div className="w-full max-w-2xl">
                <div className="bg-white/5 border border-white/10 rounded-2xl shadow-xl p-8 relative backdrop-blur text-white">
                    <button 
                        onClick={() => navigate(-1)}
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        id="fullName"
                                        type="text"
                                        className="block w-full pl-10 pr-3 py-3 border border-white/10 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent bg-white/5 text-white placeholder:text-gray-500"
                                        disabled
                                        {...register('fullName')}
                                    />
                                </div>
